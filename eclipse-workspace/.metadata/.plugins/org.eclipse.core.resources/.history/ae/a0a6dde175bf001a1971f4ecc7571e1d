...
/*Materia*/
insert into materia(clave_materia, nombre_materia, estatus_materia_id) VALUES('AB1','Procesos Digitales', 1);
insert into materia(clave_materia, nombre_materia, estatus_materia_id) VALUES('FG3','Algorítmos Programacionales', 1);

/*Grupos*/
insert into grupo(materia_id, cantidad_alumnos, estatus_grupo_id) VALUES(1,20,1);
